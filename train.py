...
from votegrasp import VoteGrasp, get_loss
from pytorch_utils import BNMomentumScheduler
from votegrasp_dataset import VoteGraspDataset, collate_fn, load_grasp_labels
...
TRAIN_DATASET = VoteGraspDataset(cfgs.dataset_root, valid_obj_idxs, grasp_labels, camera=cfgs.camera, split='train', num_points=cfgs.num_point, remove_outlier=True, augment=True)
TEST_DATASET = VoteGraspDataset(cfgs.dataset_root, valid_obj_idxs, grasp_labels, camera=cfgs.camera, split='test_seen', num_points=cfgs.num_point, remove_outlier=True, augment=False)
